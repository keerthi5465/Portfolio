...
export const Hero = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center pt-16 bg-[#111827]">
      ...
      >
        <a 
          href="#about" 
          className="flex flex-col items-center text-gray-400 hover:text-portfolio-primary transition-colors duration-300"
        >
